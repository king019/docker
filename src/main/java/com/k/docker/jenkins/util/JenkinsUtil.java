...
public class JenkinsUtil {
    ...
    public void jenkinsWrite(int multi, List<String> includes, List<String> excludes, boolean replace) throws Exception {
        ...
        writeLocal(DockerRegionEnum.LOCAL, models, false, multi);
    }
    ...
    private void writeLocal(DockerRegionEnum regionEnum, List<DockerJenkinsModel> models, boolean mix, int multi) {
        ...
        writeShell(regionEnum.getRegion() + "/", models, mix, multi);
    }

    private void writeNormal(String dir, List<DockerJenkinsModel> models, boolean mix, int multi) {
        ...
        writeShell(dir, models, mix, multi);
    }

    private void writeShell(String dir, List<DockerJenkinsModel> models, boolean mix, int multi) {
