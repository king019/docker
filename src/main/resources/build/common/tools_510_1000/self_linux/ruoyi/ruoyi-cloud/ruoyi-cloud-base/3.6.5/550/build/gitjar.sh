...
find . -name ruoyi-gateway.jar  | awk '{print "cp " $1  " /opt/soft/"}' | sh
find . -name ruoyi-auth.jar  | awk '{print "cp " $1  " /opt/soft/"}' | sh
find . -name ruoyi-modules-system.jar | awk '{print "cp " $1  " /opt/soft/"}' | sh
find . -name ruoyi-modules-gen.jar | awk '{print "cp " $1  " /opt/soft/"}' | sh
find . -name ruoyi-modules-job.jar | awk '{print "cp " $1  " /opt/soft/"}' | sh
find . -name ruoyi-modules-file.jar | awk '{print "cp " $1  " /opt/soft/"}' | sh
find . -name ruoyi-visual-monitor.jar | awk '{print "cp " $1  " /opt/soft/"}' | sh
