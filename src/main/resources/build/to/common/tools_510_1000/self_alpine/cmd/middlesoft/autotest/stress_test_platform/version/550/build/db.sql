...
CREATE TABLE `test_stress_slave` (
  ...
  `jmeter_port` INT NOT NULL DEFAULT 1099 COMMENT 'Jmeter链接端口号',
  `user_name` varchar(100) COMMENT '节点机用户名',
  `passwd` varchar(100) COMMENT '节点机密码',
  `ssh_port` int NOT NULL DEFAULT 22 COMMENT 'ssh链接端口号',
...
INSERT INTO `sys_config` (`id`, `key`, `value`, `status`, `remark`) VALUES ('2', 'MASTER_JMETER_HOME_KEY', '/apache-jmeter-5.6.3', '1', '本地Jmeter_home绝对路径');
INSERT INTO `sys_config` (`id`, `key`, `value`, `status`, `remark`) VALUES ('3', 'MASTER_JMETER_CASES_HOME_KEY', '/stressTestCases', '1', '本地保存用例数据的绝对路径，不要随意切换会导致文件找不到错误。');
