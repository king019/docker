...
source /etc/profile
cd /opt/soft
nohup java $JAVA_OPTS -Ddubbo.registry.address=nacos://nacos:8848 -Dadmin.config-center=nacos://nacos:8848 -Dadmin.metadata-report.address=nacos://nacos:8848 -jar dubbo-admin-release.jar &
